...
public class Main
{
	...
	public static void main(String[] args)
	{
		...
		//view.setRecord(rec1);								// setter injection <-> constructor injection
															// setter를 통한 주입
		view.setRecord(rec2); // 매개변수를 뭘 넣어주냐에 따라 다른 구조
		...
		*/
		...
		// RecordView view = (RecordView)context.getBean("view");			// new RecordViewImpl(); 대체
	
		// 스프링 3.0 이후 버전부터 사용 가능한 코드
		RecordView view = context.getBean("view", RecordViewImpl.class);	// 다운캐스팅 안해줘도 됨
